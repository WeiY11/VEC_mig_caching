...
```bash
# 预览模式（不实际修改）
python experiments/camtd3_strategy_suite/optimize_experiments.py --dry-run

# 执行优化（会备份原文件）
python experiments/camtd3_strategy_suite/optimize_experiments.py

# 恢复原始配置
python experiments/camtd3_strategy_suite/optimize_experiments.py --restore
```
"""
