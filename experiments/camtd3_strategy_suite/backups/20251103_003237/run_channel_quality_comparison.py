...
CHANNEL_CONFIGS = [
    {
        "key": "excellent",
        "label": "Excellent",
        "description": "LOS场景，低干扰（SNR>20dB）",
        "noise_power_dbm": -180.0,  # 低噪声
        "path_loss_exponent": 2.2,   # LOS典型值
        "shadow_fading_std": 3.0,    # 低波动
        "estimated_snr_db": 22,
    },
    {
        "key": "good",
        "label": "Good",
        "description": "LOS场景，中等干扰（15-20dB）",
        "noise_power_dbm": -176.0,
    ...
    },
    {
        "key": "medium",
        "label": "Medium",
        "description": "NLOS场景，标准干扰（10-15dB）",
        "noise_power_dbm": -174.0,  # 标准热噪声
        "path_loss_exponent": 3.0,   # NLOS典型值
        "shadow_fading_std": 6.0,    # 中等波动
        "estimated_snr_db": 12,
    },
    {
        "key": "poor",
        "label": "Poor",
        "description": "NLOS场景，高干扰（5-10dB）",
        "noise_power_dbm": -170.0,
    ...
    },
    {
        "key": "bad",
        "label": "Bad",
        "description": "极端NLOS，严重干扰（<5dB）",
        "noise_power_dbm": -166.0,  # 高噪声
        "path_loss_exponent": 4.0,   # 严重遮挡
        "shadow_fading_std": 10.0,   # 高波动
        "estimated_snr_db": 3,
    },
]
