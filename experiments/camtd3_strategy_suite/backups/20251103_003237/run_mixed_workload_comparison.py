...
WORKLOAD_CONFIGS = [
    {
        ...
        "description": "高计算密度，小数据量（AR/VR渲染）",
        "task_complexity_multiplier": 1.8,
        "task_compute_density": 600.0,
        "task_data_size_kb": 100,
        "task_arrival_rate": 0.30,
    },
    {
        "key": "data_intensive",
        "label": "Data-Intensive",
        "description": "大数据量，中等计算（视频分析）",
        "task_complexity_multiplier": 1.0,
        "task_compute_density": 400.0,
        "task_data_size_kb": 800,
        "task_arrival_rate": 0.25,
    },
    {
        "key": "latency_critical",
        "label": "Latency-Critical",
        "description": "低时延需求（自动驾驶决策）",
        "task_complexity_multiplier": 0.8,
        "task_compute_density": 300.0,
        "task_data_size_kb": 200,
        "task_arrival_rate": 0.40,  # 高频次
    },
    {
        "key": "balanced_mix",
        "label": "Balanced Mix",
        "description": "均衡混合（标准场景）",
        "task_complexity_multiplier": 1.2,
        "task_compute_density": 450.0,
        "task_data_size_kb": 400,
        "task_arrival_rate": 0.30,
    },
    {
        "key": "extreme_mix",
        "label": "Extreme Mix",
        "description": "极端混合（峰值负载）",
        "task_complexity_multiplier": 1.5,
        "task_compute_density": 550.0,
        "task_data_size_kb": 600,
        "task_arrival_rate": 0.45,
    },
]
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Compare CAMTD3 strategies under mixed workload scenarios."
    )
    add_common_experiment_args(
        parser,
