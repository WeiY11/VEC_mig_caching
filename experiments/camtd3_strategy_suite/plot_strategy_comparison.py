#!/usr/bin/env python3
"""
Plot normalized average cost for CAMTD3 strategy ablations.
"""
...
def plot_line(labels: List[str], values: List[float], output_path: Path) -> None:
    ...
    plt.xlabel("Strategy")
    plt.title("CAMTD3 Strategy Cost Comparison")
    plt.tight_layout()
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Plot normalized cost comparison for CAMTD3 strategies.")
