...
COMPUTE_CAPACITY_CONFIGS = [
    {
        "key": "low",
        "label": "Low-Config",
        "description": "低配边缘服务器（成本敏感型）",
        "rsu_compute_ghz": 5.0,
        "uav_compute_ghz": 4.0,
        "relative_cost": 1.0,  # 相对成本（基准=1.0）
    },
    {
        "key": "standard",
    ...
    {
        "key": "extreme",
        "label": "Extreme-Config",
        "description": "极限配置（探索上界）",
        "rsu_compute_ghz": 25.0,
        "uav_compute_ghz": 20.0,
        "relative_cost": 7.0,
    },
]
