...
from experiments.td3_strategy_suite.plot_strategy_comparison import (
    compute_normalized_costs,
    load_summary,
    plot_line,
)
from experiments.td3_strategy_suite.run_strategy_training import (
    DEFAULT_EPISODES,
    DEFAULT_SEED,
    STRATEGY_ORDER,
    run_strategy,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Execute multiple TD3 strategy runs and produce the comparison plot."
    )
    add_common_experiment_args(
        parser,
        default_suite_prefix="TD3_suite",
